...
def frames_da_tela(inp_menu):
    ...
    #frame_1.rowconfigure([0, 1, 2, 3, 4], weight=1)
...
def componentes_frame1(inp_menu):
    ...
    fotoimg1_pg1.grid(row=0, column=0, padx=20, pady=20, sticky='nsw')
    ...
    bt_fechar_aba_menu.grid(row=0, column=2, columnspan=2, padx=10, pady=10, sticky='ne')
